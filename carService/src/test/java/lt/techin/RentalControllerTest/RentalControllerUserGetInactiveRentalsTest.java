...
public class RentalControllerUserGetInactiveRentalsTest {
    ...
    void getInactiveRentals_whenUser_thenReturnAnd200() throws Exception {
        ...
        Rental rental1 = new Rental(user, car1, LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 10), BigDecimal.valueOf(500.00));
        Rental rental2 = new Rental(user, car2, LocalDate.of(2024, 3, 5), LocalDate.of(2024, 3, 10), BigDecimal.valueOf(225.00));
        rental1.setId(1L);
        rental2.setId(2L);
